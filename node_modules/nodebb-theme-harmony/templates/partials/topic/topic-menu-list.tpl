...
<!-- Dropdown item for best response -->
<li>
    <a href="javascript:void(0);" class="dropdown-item rounded-1 d-flex align-items-center gap-2" role="menuitem">
        <i class="fa fa-fw fa-check-circle text-secondary"></i> Best Response
    </a>
</li>
