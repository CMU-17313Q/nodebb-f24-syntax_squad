...
<!-- Dropdown item for best response, trying to implement UI functionality -->
<li>
    <a component="topic/best-response" href="#" class="dropdown-item rounded-1 d-flex align-items-center gap-2" role="menuitem">
        <i class="fa fa-fw fa-check-circle text-secondary"></i> Mark as Best Response
    </a>
</li>
