<div class="title-container align-items-center gap-2 d-flex">
	...
	<div class="{{{ if !template.compose }}}d-none d-md-flex{{{ else }}}d-flex{{{ end }}} action-bar gap-1 align-items-center">
		...
		<button class="btn btn-sm btn-link text-body fw-semibold mark-as-important" data-action="mark-important">
			<i class="fa fa-star"></i> <span class="d-none d-md-inline">Mark as Important</span>
		</button>
